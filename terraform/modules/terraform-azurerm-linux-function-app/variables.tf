  ...
  type = map(object({
    ...
    site_config = list(object({ # Required
      ...
      application_stack = list(object({
        ...
        docker = list(object({
          ...
          registry_password = string # the value will be automatically encrypted.
        }))
      }))
    ...
    auth_settings = list(object({
      ...
      active_directory = list(object({
        ...
        client_secret              = string # the value will be automatically encrypted.
        client_secret_setting_name = string
      }))

      facebook = list(object({
        app_id                  = string # Required
        app_secret              = string # the value will be automatically encrypted.
      ...
      twitter = list(object({
        ...
        consumer_secret              = string # the value will be automatically encrypted.
    ...
    backup = list(object({
      name                = string # Required
      storage_account_url = string # Required, the value will be automatically encrypted.
      enabled             = bool
    ...
    storage_account = list(object({
      access_key   = string # Required, the value will be automatically encrypted.
