resource "azurerm_linux_function_app" "this" {
      ...
      dynamic "application_stack" {
        ...
        content {
          ...
          dynamic "docker" {
            ...
            content {
              registry_url      = d.value.registry_url # Required
              image_name        = d.value.image_name   # Required
              image_tag         = d.value.image_tag    # Required
              registry_username = d.value.registry_username
              registry_password = sensitive(d.value.registry_password) # the value will be automatically encrypted.
            }
          }
        }
      }
    ...
    content {
      ...
      dynamic "active_directory" {
        ...
        content {
          ...
          client_secret              = sensitive(ad.value.client_secret) # the value will be automatically encrypted.
      ...
      dynamic "facebook" {
        ...
        content {
          ...
          app_secret              = sensitive(fb.value.app_secret) # the value will be automatically encrypted.
      ...
      dynamic "github" {
        ...
        content {
          ...
          client_secret              = sensitive(git.value.client_secret) # the value will be automatically encrypted.
      ...
      dynamic "google" {
        ...
        content {
          ...
          client_secret              = sensitive(g.value.client_secret) # the value will be automatically encrypted.
      ...
      dynamic "microsoft" {
        ...
        content {
          ...
          client_secret              = sensitive(ms.value.client_secret) # the value will be automatically encrypted.
      ...
      dynamic "twitter" {
        ...
        content {
          ...
          consumer_secret              = sensitive(tw.value.consumer_secret) # the value will be automatically encrypted.
  ...
  dynamic "backup" {
    ...
    content {
      ...
      storage_account_url = sensitive(b.value.storage_account_url) # Required, the value will be automatically encrypted.
  ...
  dynamic "connection_string" {
    ...
    content {
      ...
      value = sensitive(cs.value.value) # Required, the value will be automatically encrypted.
    }
  }
  ...
  dynamic "storage_account" {
    ...
    content {
      access_key   = sensitive(sa.value.access_key) # Required, the value will be automatically encrypted.
