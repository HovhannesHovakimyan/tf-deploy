module "linux_function_app" {
  ...
  azurerm_linux_function_app_params = {
    ...
    #   name                = module.naming["edw_linux_function_app_1"].function_app.name_unique     # Required
    #   resource_group_name = module.resource_group.resource_groups["edw_rg"].name                   # Required
    #   service_plan_id     = module.azurerm_service_plan.service_plans["edw_service_plan_linux"].id # Required

    #   app_settings = {
    #     "APPINSIGHTS_INSTRUMENTATIONKEY"             = module.app_insights.application_insights["edw_app_insights"].instrumentation_key
    #     "EtlStudycastMover_StudycastExchangeStorage" = module.storage_account.storage_accounts["edw_storage_account"].primary_connection_string
    #     "EtlStudycastMover_TableNameToInsertReport"  = "public.study_cast2"
    #     "KEY_VAULT_NAME"                             = module.key_vault.key_vaults["edw_key_vault"].name
    ...
    #     "studycast_exchange_storage"                 = module.storage_account.storage_accounts["edw_storage_account"].primary_connection_string
    #     "timerSchedule"                              = "0 0 * * * *"
    #   }
    ...
    #   storage_account_name                           = module.storage_account.storage_accounts["edw_storage_account"].name
    #   storage_uses_managed_identity                  = null # Conflicts with storage_account_access_key
    #   storage_key_vault_secret_id                    = null
    #   virtual_network_subnet_id                      = module.subnet.subnets["edw_linux_subnet"].id
