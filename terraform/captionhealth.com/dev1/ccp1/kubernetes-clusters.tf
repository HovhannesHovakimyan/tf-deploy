module "kubernetes_cluster" {
  ...
  azurerm_kubernetes_cluster_params = {
    # ccp_main_aks = {
    #   name                = module.naming["ccp_main_aks"].kubernetes_cluster.name_unique # Required
    ...
    #   dns_prefix                          = format("%s-%s", local.project, "aks")
    ...
    #   node_resource_group                 = module.naming["ccp_aks_node_rg"].resource_group.name_unique
    #   oidc_issuer_enabled                 = null
    #   open_service_mesh_enabled           = null
    #   private_cluster_enabled             = true
    #   private_dns_zone_id                 = module.private_dns_zone.private_dns_zones["ccp_private_dns_zone_private_endpoint_main_aks"].id
    ...
    #   default_node_pool = [
    #     {
    #       name                          = "systempool"       # Required
    #       vm_size                       = "Standard_D8ds_v5" # Required
    ...
    #       os_sku                        = null
    #       pod_subnet_id                 = module.subnet.subnets["ccp_aks_pods_subnet"].id
    ...
    #       vnet_subnet_id    = module.subnet.subnets["ccp_aks_nodes_subnet"].id
    ...
    #     {
    #       managed                = true
    #       tenant_id              = "4f47fb49-521c-4371-be4e-d9ae5b4b691b"
    #       admin_group_object_ids = ["957722b1-3618-49cb-a958-982afb401754"]
    ...
    #   identity = [
    #     {
    #       type         = "UserAssigned" # Required
    #       identity_ids = [module.user_assigned_identity.user_assigned_identities["user_assigned_identity_main_aks"].id]
    #     }
    #   ]
